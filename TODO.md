...
- Status: In progress on 2026-08-28. Studio ownership, private application records, game drafts, a studio portal, separate testnet USDC listing-fee verification, administrator review, immutable audit events, and hashed/scoped/revocable game-server API credentials are implemented locally; the hosted migration, live fee exercise, and signed result-submission protocol remain.
